...
Route::post('/auth/demo', [DemoAuthController::class, 'login']); // Демо-вход без пароля

Route::middleware(['auth.jwt', 'demo.readonly'])->group(function () {
...
Route::prefix('stuffer')->middleware(['auth.jwt', 'demo.readonly'])->group(function () {
