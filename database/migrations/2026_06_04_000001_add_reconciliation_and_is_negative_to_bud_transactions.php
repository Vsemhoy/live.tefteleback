...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE bud_transactions MODIFY COLUMN flow_kind ENUM('expense','income','transfer_out','transfer_in','adjustment','reconciliation') NOT NULL");
    }
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE bud_transactions MODIFY COLUMN flow_kind ENUM('expense','income','transfer_out','transfer_in','adjustment') NOT NULL");
    }
};
