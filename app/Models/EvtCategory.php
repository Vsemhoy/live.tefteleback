...
class EvtCategory extends Model
{
    protected $table = 'evt_categories'; // Укажите имя таблицы, если оно не соответствует имени модели
    ...
    {
        return $this->hasMany(EvtEvent::class, 'category_id');
    }
